...
urlpatterns = [
    ...
    # 3. Application Status (Dual routes: primary specification & PakUniPortal default)
    ...
    # 4. Student Notifications (Dual routes: primary specification & PakUniPortal default)
    ...
    # 5. Roll Slip (Dual routes: primary specification & PakUniPortal default)
