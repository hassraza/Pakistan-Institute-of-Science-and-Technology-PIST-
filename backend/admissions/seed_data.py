...
PROGRAM_DATA = [
    ...
    p('BSAI-ISB', 'Bachelor of Science in Artificial Intelligence', 'AI', ['pre_engineering', 'ics'], 65, ['usat', 'pist'], '4 Years', 'Undergraduate', 'Machine Learning Engineer\nData Scientist\nArtificial Intelligence Research Assistant\nComputer Vision Engineer'),
    p('BSDS-ISB', 'Bachelor of Science in Data Science', 'DS', ['pre_engineering', 'ics'], 60, ['usat', 'pist'], '4 Years', 'Undergraduate', 'Data Analyst\nData Engineer\nBusiness Intelligence Analyst'),
    p('BSIT-ISB', 'Bachelor of Science in Information Technology', 'IT', ['pre_engineering', 'ics'], 55, ['usat', 'pist'], '4 Years', 'Undergraduate', 'Network Administrator\nInformation Technology Support Engineer\nSystems Administrator\nWeb Developer'),
    p('BSCYS-ISB', 'Bachelor of Science in Cyber Security', 'CYS', ['pre_engineering', 'ics'], 60, ['usat', 'pist'], '4 Years', 'Undergraduate', 'Security Analyst\nPenetration Tester\nNetwork Security Engineer\nDigital Forensics Investigator'),
